...
int main(int argc, char **argv) {
  ...
  FILE *csv = bench_csv_open(csv_path,
      "benchmark,n_threads,iterations,is_glibc,chunks_per_thread,chunk_size,work,time_us,throughput_alloc_per_s,peak_rss_kb");
  if (csv) {
    fprintf(csv, "threadtest,%d,%lld,%d,%lld,%lld,%lld,%.3f,%.3f,%ld\n",
