...
int main(int argc, char **argv) {
  ...
  FILE *csv = bench_csv_open(csv_path,
      "benchmark,n_threads,iterations,is_glibc,time_us,throughput_alloc_per_s,peak_rss_kb,chunks_per_thread,chunk_size,work");
  if (csv) {
    fprintf(csv, "threadtest,%d,%lld,%d,%.3f,%.3f,%ld,%lld,%lld,%lld\n",
